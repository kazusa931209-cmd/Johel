...
* **Generate** (`/`)
  ...
  * **Job** step: left column shows a **live filtered Job Description preview** (noise filter applied to the current input); right column is the Job input (method tabs + manual textarea)
