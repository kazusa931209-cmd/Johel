...
* [x] **Phase 49 — Quick PCE authoring advisor** — Global plus FAB beside AI Usage History opens Quick PCE: optional workflow scope, required “What do you need?”, advisor suggestion drawer, and confirmed Apply to Company / Experience / Workflow links.
  * **Outcome (2026-09-08):** `POST /ai-author-advise`, `POST /ai-author-advise/apply`, `StudioBottomFabCluster`, `authorAdvise` usage type. Details in [`docs/technology.md`](./technology.md). Plan archived at [`docs/plans/2026-09-08-phase-49-quick-pce.md`](./plans/2026-09-08-phase-49-quick-pce.md).
