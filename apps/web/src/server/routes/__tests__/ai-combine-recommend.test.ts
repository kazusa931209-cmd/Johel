...
vi.mock("../../lib/ai-combine-recommend/index", async (importOriginal) => {
...
const testDbPath = resolve(webRoot, "test-combine-recommend.db");
...
const { encryptApiKeyForStorage } = await import("../../lib/secrets/api-key.js");
