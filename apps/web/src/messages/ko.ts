...
export const ko: MessageTree = {
  ...
  crud: {
    ...
    experiences: {
      ...
      delete: {
        title: "경험 보관",
        body: '경험 "{name}"을(를) 보관할까요? 워크스페이스에서 숨겨집니다. 저장된 생성 기록에는 Combine에서 다시 연결할 때까지 참조가 남을 수 있습니다.',
      },
      split: {
        actionAria: "역량별 분할",
        denseBadge: "밀집",
        densityProblemShort: "문",
        densityActionsShort: "행",
        densityOutcomeShort: "결",
        densityTotalShort: "합",
        densityProblemHint: "문제 bullet 수 (밀집 기준: {limit} 초과)",
        densityActionsHint: "행동 bullet 수 (밀집 기준: {limit} 초과)",
        densityOutcomeHint: "결과 bullet 수 (밀집 기준: {limit} 초과)",
        densityTotalHint: "전체 bullet 수 (밀집 기준: {limit} 초과)",
        drawerTitle: "경험 분할",
        sourceCard: "원본 카드",
        suggest: "분할 제안",
        suggesting: "제안 중…",
        ...
        busy: {
          title: "카드 분석 중…",
          description: "AI가 집중된 역량 카드를 제안하는 동안 잠시 기다려 주세요.",
        },
        applyingBusy: {
          title: "분할 적용 중…",
          description: "새 카드를 저장하고 원본 카드를 보관하는 동안 잠시 기다려 주세요.",
        },
      },
      form: {
        addTitle: "경험 추가",
  ...
  generate: {
    ...
    job: {
      ...
      jdCompanyName: "JD 회사명",
      jdCompanyNamePlaceholder: "채용 공고의 회사명",
      jdJobRole: "JD 직무",
      jdJobRolePlaceholder: "채용 공고의 직무 또는 직함",
    ...
    jobDuplicate: {
      ...
      newJdMeta: "새 채용 공고",
      matchedJd: "검출된 채용 공고",
      matchedMetaFinalizedPrefix: "실행 ID",
      matchedMetaFinalizedSuffix: "· 확정됨",
      matchedMetaUnfinishedPrefix: "실행 ID",
      matchedMetaUnfinishedSuffix: "· 진행 중",
      cancel: "취소",
      continue: "계속",
  ...
  history: {
    ...
    resumeConfirm: {
      title: "이 생성을 재개할까요?",
      bodyPrefix: "현재 생성(",
      bodyMiddle: ")은 기록에 저장됩니다.",
      bodySuffix: "가 활성 Generate 세션이 됩니다.",
      bodyNoCurrentSuffix: "가 활성 Generate 세션이 됩니다.",
      confirm: "재개",
      confirming: "재개 중…",
    },
    detail: {
  ...
  toast: {
    ...
    experienceArchived: "경험을 보관했습니다.",
    experienceSplitFailed: "경험 분할에 실패했습니다.",
    experienceSplitReady: "분할 제안이 준비되었습니다.",
    experienceSplitApplied: "경험 분할을 적용했습니다.",
    experienceArchivedLinkRemoved:
      "보관되었거나 없는 경험 연결이 Combine에서 제거되었습니다. 생성 전에 live 카드를 다시 연결하세요.",
